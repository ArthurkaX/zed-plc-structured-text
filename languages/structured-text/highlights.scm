...
((identifier) @keyword
  (#match? @keyword "^(ACTION|ARRAY|BEGIN|BY|CASE|CONFIGURATION|CONSTANT|CONTINUE|DATA_BLOCK|DO|ELSE|ELSIF|END_ACTION|END_CASE|END_CONFIGURATION|END_DATA_BLOCK|END_FUNCTION|END_FUNCTION_BLOCK|END_FOR|END_IF|END_METHOD|END_NAMESPACE|END_ORGANIZATION_BLOCK|END_PROGRAM|END_REPEAT|END_STRUCT|END_TYPE|END_VAR|END_WHILE|EXIT|FOR|FUNCTION|FUNCTION_BLOCK|IF|INITIAL_STEP|INTERFACE|METHOD|NAMESPACE|OF|ORGANIZATION_BLOCK|PROGRAM|REPEAT|RESOURCE|RETURN|STEP|STRUCT|THEN|TO|TRANSITION|TYPE|UNTIL|VAR|VAR_CONFIG|VAR_GLOBAL|VAR_INPUT|VAR_IN_OUT|VAR_OUTPUT|VAR_TEMP|VERSION|WHILE)$"))
